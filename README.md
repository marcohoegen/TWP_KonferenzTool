...
5. docker compose up
6. docker exec -it nest-backend npx prisma migrate deploy --> wenn das nicht funktioniert, folgendes probieren: docker exec -it nest-backend npx prisma generate
