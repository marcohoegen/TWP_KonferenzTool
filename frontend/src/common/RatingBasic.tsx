...
export default function RatingBasic({
  ...
  useEffect(() => {
    ...
    const fetchRating = async () => {
      ...
      try {
        ...
        if (!res.ok) throw new Error("Fehler beim Laden der Bewertung")
  ...
  // 💛 Hilfsfunktion: erzeugt Sterne mit Teilfüllung
  const renderStars = () => {
    const stars = []
          ...
          >
            <path
              ...
              d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111
                 ...
                 l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562
                 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54
                 a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557
                 l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442
                 a.563.563 0 00.475-.345L11.48 3.5z"
            />
          </svg>

          {/* Gefüllter Stern mit Clip-Maske */}
          <div
